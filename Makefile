...
# Generated by qmake (2.01a) (Qt 4.8.7) on: mar. mars 26 15:53:25 2019
# Project:  main.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/projetAlpes1.0.0/ && $(COPY_FILE) --parents shader.h trackball.h camera.h viewer.h grid.h .tmp/projetAlpes1.0.0/ && $(COPY_FILE) --parents shader.cpp trackball.cpp camera.cpp main.cpp viewer.cpp grid.cpp .tmp/projetAlpes1.0.0/ && (cd `dirname .tmp/projetAlpes1.0.0` && $(TAR) projetAlpes1.0.0.tar projetAlpes1.0.0 && $(COMPRESS) projetAlpes1.0.0.tar) && $(MOVE) `dirname .tmp/projetAlpes1.0.0`/projetAlpes1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/projetAlpes1.0.0
